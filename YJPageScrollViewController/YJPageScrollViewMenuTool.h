...
typedef NS_ENUM(NSInteger, YJPageScrollViewMenuStyle) {
    YJPageScrollViewMenuStyleTop = 0,           // 顶部 默认
    YJPageScrollViewMenuStyleNavigation = 1,    // 导航条
    YJPageScrollViewMenuStyleSuspension = 2     // 悬浮
};

@interface YJPageScrollViewMenuTool : NSObject
...
/** 菜单位置风格 默认 0 */
@property (nonatomic, assign) YJPageScrollViewMenuStyle pageScrollViewMenuStyle;
/** 是否显示遮盖*/
...
+ (instancetype)pageScrollViewMenuTool;
