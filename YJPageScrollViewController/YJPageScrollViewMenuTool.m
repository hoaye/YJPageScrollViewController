...
@interface YJPageScrollViewMenuTool ()
...
@implementation YJPageScrollViewMenuTool
...
- (instancetype)init{
    ...
    if (self) {
        _showNavigation = YES;
        _showTabbar = NO;
        _pageScrollViewMenuStyle = YJPageScrollViewMenuStyleTop;
        _showConver = NO;
        _showScrollLine = YES;
